...
namespace com.xrpractices.curvedui
{
    ...
    public class CurvedUI : MonoBehaviour
    {
        ...
        [Range(30, 360)] public float chordangle = 180f;
        ...
        void Initialize()
        {
            ...
            if (gameObject.GetComponent<MeshRenderer>() == null)
            {
                gameObject.AddComponent<MeshRenderer>().sharedMaterial =
                    Resources.Load("Materials/CurvedUIMaterial", typeof(Material)) as Material;
            ...
            meshFilter.sharedMesh =
                MeshGenerator.GenerateMesh(meshresolution, curveradius, height, chordangle);
